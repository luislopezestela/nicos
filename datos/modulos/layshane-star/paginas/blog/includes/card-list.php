	...
	<div class="wow_main_blogs">
		<div class="avatar">
			...
			<div class="wow_main_blogs_info">
				...
				<h2 class="art-title"><a href="<?php echo $wo['article']['url']; ?>"><?php echo $wo['article']['title']; ?></a></h2>
				...
				<a href="<?php echo $wo['article']['url']; ?>" class="btn btn-mat"><?php echo $wo['lang']['read_more'] ?></a>
			</div>
		</div>
	</div>
</div>