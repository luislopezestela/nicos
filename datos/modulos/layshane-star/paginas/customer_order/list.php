<div class="col-sm-3 ch_main_items">
	<div class="prod_img">
		...
		<?php if ($wo['can_review'] > 0 && $wo['is_reviewed'] < 1) { ?>
			<a class="btn" href="javascript:void(0)" onclick="OpenWriteReview('<?php echo $wo['order']->product['id']?>')"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24"><path fill="currentColor" d="M12,17.27L18.18,21L16.54,13.97L22,9.24L14.81,8.62L12,2L9.19,8.62L2,9.24L7.45,13.97L5.82,21L12,17.27Z" /></svg> <?php echo $wo['lang']['write_review']; ?></a>
		<?php } ?>
	</div>
    <div class="prod_info">
