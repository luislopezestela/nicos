	...
	<div class="product_info wow_main_mkt_prod">
		...
		<div class="produc_info">
			...
			<div class="product-title">
				<a href="<?php echo $wo['product']['url']?><?=$el_color;?>" data-ajax="?link1=item&items=<?=$wo['product']['seo_id'].$el_color_b;?>" title="<?php echo $wo['product']['name']?>"><?php echo $wo['product']['name']?></a>
			</div>
