...
.terms{padding-left:22px;position:relative;position:relative;}
.terms input[type=checkbox]{opacity:0;margin:0 0 6px 4px;display:none}
.terms label::after,.terms label::before{display:inline-block;left:0;margin-left:0px}
.terms label{padding-left:30px;cursor: pointer;user-select: none;font-size: 16px;opacity: 0.9;position:relative;}
.terms label::before{content:"";position:absolute;width: 24px;height: 24px;top:0px;border: 2px solid #b4b4b4;border-radius: 5px;transition:all 90ms cubic-bezier(0,0,.2,.1)}
...
.btn{
   ...
   outline: none;
   border: none;
   background-image:linear-gradient(to right, #53b4ea, #01deff, #ffffff);
   background-size: 200%;
   font-size: 1.2rem;
   color: #fff;
   font-family: 'Poppins', sans-serif;
...
.btn:hover{
   ...
   display: block;
   background-image:linear-gradient(to left, #00a4ff, #00deff, #36afca);
   transform: scale(104%);
}
