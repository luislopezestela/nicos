<?php $section = $db->where('id', $wo['category_section_lang_key'])->getOne('section_product');?>
<tr id="list-<?php echo($wo['category_lang_key']) ?>" data_selected="<?php echo($wo['category_lang_key']) ?>">
  ...
  <td>
  	<button class="btn bg-success admn_table_btn"onclick="edit_category('<?php echo($wo['category_lang_key']) ?>','<?php echo($wo['category_key']) ?>','<?php echo($wo['category_section_lang_key']) ?>')">Editar</button>
