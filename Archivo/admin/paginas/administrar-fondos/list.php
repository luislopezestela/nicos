<tr class="setting-postlist" id="PostID_<?php echo $wo['story']->id?>" data-post-id="<?php echo $wo['story']->id?>" data_selected="<?php echo $wo['story']->id ?>">
   ...
   <td><a href="<?php echo $wo['site_url'].'/show_fund/'. $wo['story']->hashed_id;?>" target="_blank">Mostrar fondo</a></td>
   <td>
   ...
   <td>
      <button onclick="Wo_AdminDeletePost(<?php echo $wo['story']->id?>,'hide');" type="button" class="btn bg-danger admn_table_btn">Delete</button>
   </td>
</tr>