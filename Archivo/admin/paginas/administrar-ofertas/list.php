<tr class="setting-postlist" id="PostID_<?php echo $wo['story']->id?>" data-post-id="<?php echo $wo['story']->id?>" data_selected="<?php echo $wo['story']->id ?>">
   ...
   <td><?php echo !empty($wo['story']->offer['description'])  ? mb_substr($wo['story']->offer['description'], 0, 50, "UTF-8") : '';?></td>
   <td><a href="<?php echo $wo['story']->offer['url'];?>" target="_blank"><?php echo $wo['lang']['open_post'];?></a></td>
   <td>
