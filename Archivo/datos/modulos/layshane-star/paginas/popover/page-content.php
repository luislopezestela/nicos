<div class="user-fetch">
	...
	<ul class="user-information">
		...
		<li>
			...
			<?php echo lui_CountPageLikes($wo['popover']['page_id']);?> <?php echo $wo['lang']['people_likes_this']; ?>
		</li>
	</ul>
	<div class="clear"></div>
</div>